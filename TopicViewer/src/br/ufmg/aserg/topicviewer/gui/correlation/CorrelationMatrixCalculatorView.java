...
import br.ufmg.aserg.topicviewer.control.correlation.CorrelationMatrixController;
import br.ufmg.aserg.topicviewer.gui.AbstractView;
import br.ufmg.aserg.topicviewer.util.Properties;

public class CorrelationMatrixCalculatorView extends AbstractView {
    ...
    public CorrelationMatrixCalculatorView() {
    	super();
        initComponents();
        initListeners();
        this.pack();
	...
	private void startExtractionActionPerformed(java.awt.event.ActionEvent evt) {                                        
        if (sourceCodePaths != null) {
            if (!startExecutionButton.getText().trim().isEmpty()) {
                this.controller = new CorrelationMatrixController(sourceCodePaths);
